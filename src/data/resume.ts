...
export const roles: Role[] = [
	{
		...
		bullets: [
			...
			'Monthly MQLs hit 239% of target; content became a measurable pipeline channel, with organic readers converting to trials and closed deals with no paid touchpoints',
