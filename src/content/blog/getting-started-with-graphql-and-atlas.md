---
title: "Building Your First GraphQL Client in JS"
date: 2020-01-16
slug: "getting-started-with-graphql-and-atlas"
...
categories: ["Blog"]
heroImage: "/images/blog/getting-started-with-graphql-and-atlas/From-SQL-to-NoSQL-Blog-Cover1.png"
---
...
- Comparison of REST to GraphQL- Intro to GraphQL
<li>Why use GraphQL?
<li>Declarative- Decoupled from storage- Validated and structured- Facilitates Collaboration- Super Fast- Graphiql
</li>- Why NOT use GraphQL
<li>More abstraction has greater performance costs- GraphQL is still very new
</li>- Intro to Apollo
<li>Declarative Data Fetching- Zero-Config Caching- Vibrant Ecosystem
</li>
</li>- Live Demo
<li>Setup GraphQL- How to do queries- How to do mutations
</li>- Final Thoughts/Recap

## Related Links

- [MongoDB University](https://joekarlsson.dev/MongoDBUniversity)- MongoDB Developer Hub- [MongoDB Community Forums](https://joekarlsson.dev/MongoDBCommunity)- [Introducing GraphQL Support in MongoDB Atlas with Stitch](https://web.archive.org/web/20200314142921/https://www.mongodb.com/blog/post/introducing-graphql-support-in-mongodb-atlas-with-stitch)- MongoDB GraphQL API Documentation (Beta) - GraphQL Types & Resolvers- [Authenticate GraphQL Requests](https://web.archive.org/web/20211209013629/https://docs.mongodb.com/realm/graphql/)- [GraphQL Official Docs](https://graphql.org/)- [GraphQL Hub](https://datahubproject.io/docs/api/graphql/overview/)- [Apollo Official Docs](https://www.apollographql.com/)
