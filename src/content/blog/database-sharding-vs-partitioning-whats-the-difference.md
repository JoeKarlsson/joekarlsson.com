...
categories: ["Blog"]
heroImage: "/images/blog/database-sharding-vs-partitioning-whats-the-difference/img_blog_post_featured_database-sharding-vs-partitioning-whats-the-difference.png"
---
...
![](/images/blog/database-sharding-vs-partitioning-whats-the-difference/diagram_employee-partition-1024x573.jpg)
...
![](/images/blog/database-sharding-vs-partitioning-whats-the-difference/diagram_shard-key-1024x567.png)
...
- [Wikipedia] Shard (database architecture): [https://en.wikipedia.org/wiki/Partition_(database)](https://en.wikipedia.org/wiki/Partition_(database))

- [Wikipedia] Partition (database): [https://en.wikipedia.org/wiki/Shard_(database_architecture)](https://en.wikipedia.org/wiki/Shard_(database_architecture))
