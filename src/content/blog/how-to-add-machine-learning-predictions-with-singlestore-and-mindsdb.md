...
tldr: 'I connect SingleStore to MindsDB to run machine learning predictions on health insurance data using just SQL. No separate ML pipeline needed - MindsDB trains the model directly on your existing tables.'
---
...
Here's what we'll cover: integrating SingleStore with MindsDB, building predictions directly into your existing tables, and querying them using simple SQL. We'll set up a SingleStore account, create a cluster, import a dataset, and then connect our SingleStore data to MindsDB to ask predictive questions and get accurate answers from it.
...
[MindsDB health insurance example dataset on GitHub](https://github.com/mindsdb/mindsdb-examples/tree/master/others/health_insurance/dataset)
